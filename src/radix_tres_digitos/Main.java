...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        radixSortTresDigitos(vector, digits);

        sc.close();

    }

    private static int highestValue(int[] a, int d) {

        int mod = (int) Math.pow(10, d), divid = (int) Math.pow(10, d - 3);
    ...
    private static int lowestValue(int[] a, int d) {
    ...
    private static int[] adaptedCountingSort(int[] a, int d) {

        int mod = (int) Math.pow(10, d);
        int divid = (int) Math.pow(10, d - 3);
    ...
    public static void radixSortTresDigitos(int[] a, int d) {
